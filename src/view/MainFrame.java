...
public class MainFrame extends JFrame {
    ...
    private static final Color SECONDARY_COLOR = new Color(241, 245, 249); // Cinza claro
    private static final Color SIDEBAR_COLOR = new Color(30, 41, 59); // Cinza escuro
    ...
    private JPanel createSidePanel() {
        ...
        sidePanel.setPreferredSize(new Dimension(250, 630));
        ...
        menuLabel.setBorder(new EmptyBorder(0, 20, 15, 0));
        sidePanel.add(menuLabel);
        
        // Botões do menu
        sidePanel.add(createMenuButton("👥 Clientes", "Gerenciar clientes do sistema", this::openCustomerScreen));
        sidePanel.add(Box.createRigidArea(new Dimension(0, 5)));
        
        sidePanel.add(createMenuButton("🚗 Entregadores", "Gerenciar entregadores", this::openDriverScreen));
        sidePanel.add(Box.createRigidArea(new Dimension(0, 5)));
        
        sidePanel.add(createMenuButton("🏪 Restaurantes", "Gerenciar restaurantes e produtos", this::openRestaurantScreen));
        sidePanel.add(Box.createRigidArea(new Dimension(0, 5)));
        
        sidePanel.add(createMenuButton("📦 Criar Pedido", "Novo pedido de delivery", this::openOrderScreen));
        sidePanel.add(Box.createRigidArea(new Dimension(0, 5)));
        
        sidePanel.add(createMenuButton("🚚 Entregas", "Acompanhar entregas em andamento", this::openDeliveryScreen));
        sidePanel.add(Box.createRigidArea(new Dimension(0, 5)));
        
        sidePanel.add(createMenuButton("📊 Relatórios", "Visualizar estatísticas", this::openReportScreen));
        ...
        sidePanel.add(createMenuButton("ℹ️ Sobre", "Informações do sistema", this::showAbout));
        sidePanel.add(Box.createRigidArea(new Dimension(0, 5)));
        
        sidePanel.add(createMenuButton("🚪 Sair", "Fechar o sistema", () -> System.exit(0)));
    ...
    private JButton createMenuButton(String text, String description, Runnable action) {
        ...
        // Painel com texto e descrição
        JPanel textPanel = new JPanel(new GridLayout(2, 1, 0, 2));
        textPanel.setBackground(SIDEBAR_COLOR);
    ...
    private JPanel createCenterPanel() {
        ...
        welcomeCard.add(welcomeIcon);
        welcomeCard.add(Box.createRigidArea(new Dimension(0, 20)));
        ...
        shortcutsPanel.add(createShortcutCard("📊", "Relatórios", "Ver estatísticas", this::openReportScreen));
    ...
    private JPanel createShortcutCard(String icon, String title, String description, Runnable action) {
